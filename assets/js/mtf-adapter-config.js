...
mtf.game.width      = "100%";           //in case mtf.game = fix, set the width (preferably in percentage)
mtf.game.height     = "100%";           //in case mtf.game = fix, set the height (preferably in percentage)

mtf.orientation     = "vertical";       //variations: horizontal, vertical
